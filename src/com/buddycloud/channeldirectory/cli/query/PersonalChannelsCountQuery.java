 ...
 *
 */
public class PersonalChannelsCountQuery implements Query {
	
	public static final String NAME = "personal-channels-count";
	...
	public String exec(String args, Properties configuration) throws Exception {
		...
		SolrQuery solrQuery = new SolrQuery("channel-type:personal");
